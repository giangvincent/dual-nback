...
export default {
    ...
    updateParameters: function (params) {
        let stimuli = Functions.calculateStimuli(params.n_level, params.clues);
        params.stimuli = stimuli;
        store.game.commit("SET_PARAMS", params)
    },

    // updates sounds whenever the #select-sound has changed its value
    updateSounds: function (soundsFolder) {
        Functions.makePlaybleSounds(enviroment.sounds[folder], folder);
    },
