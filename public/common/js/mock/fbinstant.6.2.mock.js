...
var FBInstant = {
  ...
  player: {
    ...
    getPhoto: function() {
      return FBInstant.__utils.returnUserData('./assets/img/mock/profile.png')
    },
    getID: function() {
    ...
    incrementStatsAsync: function(obj) {
      return new Promise(function(resolve, reject) {
        FBInstant.__utils
          .getFromLocalStorage('playerStats', Object.keys(obj))
          .then(function(storedObject) {
            for (var key in storedObject) {
              storedObject[key] += obj[key]
            }
            FBInstant.__utils
              .writeToLocalStorage('playerStats', storedObject)
              .then(function() {
                resolve( )
              })
          })
    ...
    canSubscribeBotAsync: function(obj) {
      return new Promise(function(resolve, reject) {
        resolve()
      })
    },
    subscribeBotAsync: function(obj) {
      return new Promise(function(resolve, reject) {
        resolve()
      })
    },
          ...
          players = [
            {
              ...
              getPhoto: function() {
                return './assets/img/mock/friend1.png'
              },
            },
            {
              getID: function() {
              ...
              getPhoto: function() {
                return './assets/img/mock/friend2.png'
              },
            },
            {
              getID: function() {
              ...
              getPhoto: function() {
                return './assets/img/mock/friend3.png'
              },
            },
          ]
        } else {
  ...
  shareAsync: function(options) {
    console.log("shareAsync", options, JSON.stringify(options.data))
    ...
    var leaderboard = {
      ...
      setScoreAsync: function(score, extraData) {
        var leaderboardEntry = FBInstant.__utils.createLeaderboardEntry(
          ...
          {
            name: 'Player 1',
            photo: './assets/img/mock/profile.png',
            id: 123456789,
          },
          extraData
        )
      ...
      getPlayerEntryAsync: function() {
        var leaderboardEntry = FBInstant.__utils.createLeaderboardEntry(42, 3, {
          name: 'Player 1',
          photo: './assets/img/mock/profile.png',
          id: 123456789,
        })
        ...
        var entries = [
          FBInstant.__utils.createLeaderboardEntry(
            ...
            3,
            {
              ...
              photo: './assets/img/mock/friend1.png',
              id: 123456789,
            },
            null
          ),
          ...
          FBInstant.__utils.createLeaderboardEntry(
            ...
            1,
            {
              ...
              photo: './assets/img/mock/friend2.png',
              id: 44,
            },
            null
          ),
      ...
      getConnectedPlayerEntriesAsync: function() {
        var entries = [
          ...
          FBInstant.__utils.createLeaderboardEntry(
            ...
            2,
            {
              name: 'Connected Player 3',
              photo: './assets/img/mock/friend3.png',
              id: 43,
            },
            null
          ),
